  ...
  switch (taskId) {
    case "historia":
      return "<h3>Tarefa em História</h3>" +
             ...
             "<img src='historia.png' alt='Imagem de História' width='500' height='550'>";
    case "geografia":
      ...
      "<img src='geografia.png' alt='Imagem de Geografia' width='500' height='550'>";
    ...
    case "filosofia":
      return "<h3>Tarefa em Filosofia</h3>" +
             ...
             "<img src='filosofia.png' alt='Imagem de Filosofia' width='500' height='550'>";
    case "sociologia":
      return "<h3>Tarefa em Sociologia</h3>" +
             ...
             "<img src='sociologia.png' alt='Imagem de Sociologia' width='500' height='550'>";
    default:
  ...
  switch (taskId) {
    case "fisica":
      return "<h3>Tarefa em Fisica</h3>" +
             ...
             "<img src='fisica.png' alt='Imagem de História' width='450' height='400'>";
    case "quimica":
      ...
      "<img src='quimica.png' alt='Imagem de História' width='450' height='400'>";
    case "biologia":
      ...
      "<img src='biologia.png' alt='Imagem de História' width='450' height='400'>";
    default:
      return "<p>Tarefa não encontrada.</p>";
  }
}
...
function getLinguagensTaskContent(taskId) {
  switch (taskId) {
    case "portugues":
      ...
      "<img src='portugues.png' alt='Imagem de História' width='450' height='400'>";
    case "ingles":
      ...
      "<img src='ingles.png' alt='Imagem de História' width='450' height='400'>";
    case "artes":
      ...
      "<img src='artes.png' alt='Imagem de História' width='450' height='400'>";
    case "educacao_fisica":
      ...
      "<img src='educacaofisica.png' alt='Imagem de História' width='450' height='400'>";
    default:
      return "<p>Tarefa não encontrada.</p>";
  }
}
...
function getMatematicaTaskContent(taskId) {
  switch (taskId) {
    case "matematica":
      ...
      "<img src='matematica.png' alt='Imagem de História' width='500' height='400'>";
    default:
      return "<p>Tarefa não encontrada.</p>";
  }
}